...
from ulearn.train_sae import collect_label_emb_features, train_sae_on_features
...
if __name__ == '__main__':
    ...
    print("==== Start collecting features for SAE ====")
    sae_save_path = os.path.join("ulearn", "sae_512_to_1024.pth")

    if not os.path.exists(sae_save_path):
        feature_tensor = collect_label_emb_features(
            model=global_model,
        ...
        print("Collected feature tensor shape:", feature_tensor.shape)

        _ = train_sae_on_features(
        ...
        print(f"SAE checkpoint already exists, skip training: {sae_save_path}")

    args.sae_ckpt = sae_save_path
    args.sae_input_dim = 512
    args.sae_latent_dim = 1024
    args.sae_activation = "relu"
