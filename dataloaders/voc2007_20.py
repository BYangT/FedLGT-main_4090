...
class Voc07Dataset(torch.utils.data.Dataset):
    def __init__(self, img_dir='/nvme/code/Fed/data/voc/VOCdevkit/VOC2007/JPEGImages', anno_path='/nvme/code/Fed/data/voc/VOCdevkit/VOC2007/Main/trainval.txt', image_transform=None, labels_path='/nvme/ytb/code/Fed/data/voc/VOCdevkit/VOC2007/Annotations',known_labels=0,testing=False,use_difficult=False):
        self.img_names  = []
