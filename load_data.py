...
def get_data(args, curr_user=None):
    ...
    if dataset == 'coco':
        ...
        train_dataset = Voc07Dataset(
            img_dir='/nvme/ytb/code/Fed/data/voc/VOCdevkit/VOC2007/JPEGImages',
            anno_path='/nvme/ytb/code/Fed/data/voc/VOCdevkit/VOC2007/ImageSets/Main/trainval.txt',
            image_transform=trainTransform,
            labels_path='/nvme/ytb/code/Fed/data/voc/VOCdevkit/VOC2007/Annotations',
            known_labels=args.train_known_labels,
            testing=False,
            use_difficult=False)
        valid_dataset = None
        ...
        test_dataset = Voc07Dataset(
            img_dir='/nvme/ytb/code/Fed/data/voc/VOCdevkit/VOC2007/JPEGImages',
            anno_path='/nvme/ytb/code/Fed/data/voc/VOCdevkit/VOC2007/ImageSets/Main/test.txt',
            image_transform=testTransform,
            labels_path='/nvme/ytb/code/Fed/data/voc/VOCdevkit/VOC2007/Annotations',
            known_labels=args.test_known_labels,
            testing=True)
